...
# $LpUrl = "http://fg.v4.download.windowsupdate.com/d/msdownload/update/software/updt/2015/07/"
# $LpFile = "lp_adc2ec900dd1c5e94fc0dbd8e010f9baabae665f.cab"
# $LpTemp = "C:\LpTemp.cab"
# Set-WinUserLanguageList ja-JP -Force
# Start-BitsTransfer -Source $LpUrl$LpFile -Destination $LpTemp
